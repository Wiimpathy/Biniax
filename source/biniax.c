...
{
	BNX_PLAYER	*p = &game->player[ pIndex ];
	//BNX_INT8	newY = p->y - 1; changed by Farox...else cursor could go out of screen
...
{
	BNX_PLAYER	*p = &game->player[ pIndex ];
	//BNX_INT8	newX = p->x - 1; changed by Farox...else cursor could go out of screen
