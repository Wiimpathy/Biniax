...
BNX_BOOL gfxInit()
{
	...
	_Gfx.screen = SDL_SetVideoMode( 640, 480, 32, SDL_FULLSCREEN );
	if ( _Gfx.screen == 0 )
	{
		return BNX_FALSE;
	}
...
BNX_BOOL gfxLoadResources()
{
	...
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/background0.png", &_Gfx.background[ cModeRealtime ]);
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/background1.png", &_Gfx.background[ cModeTurn ]);
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/background2.png", &_Gfx.background[ cModeMultiplayer ] );

	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/window.png", &_Gfx.window );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/splash.png", &_Gfx.splash );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/logo.png", &_Gfx.logo );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/help.png", &_Gfx.help );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/font.png", &_Gfx.font );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/roadmap.png", &_Gfx.roadmap );

	// Loading Game Elements
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/element0.png", &_Gfx.elements[ 0 ] );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/element1.png", &_Gfx.elements[ 1 ] );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/element2.png", &_Gfx.elements[ 2 ] );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/element3.png", &_Gfx.elements[ 3 ] );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/elementB.png", &_Gfx.elements[ 4 ] );

	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/movecount.png", &_Gfx.movecount );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/keyboard.png", &_Gfx.keyboard );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/cursor0.png", &_Gfx.cursors[ 0 ] );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/cursor1.png", &_Gfx.cursors[ 1 ] );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/marker0.png", &_Gfx.markers[ 0 ] );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/marker1.png", &_Gfx.markers[ 1 ] );

	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/particle0.png", &_Gfx.part[ 0 ] );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/particle1.png", &_Gfx.part[ 1 ] );
	bLoad &= gfxLoadImage( "/apps/biniax/data/graphics/particle2.png", &_Gfx.part[ 2 ] );

	// Set alpha
	SDL_SetAlpha( _Gfx.window, SDL_SRCALPHA | SDL_RLEACCEL, cGfxWinBlending );

	// Load Help Text
	gfxLoadHelp( "/apps/biniax/data/text/help.txt" );
