    ...
    while( SDL_PollEvent( &event ) ) 
	{
        switch( event.type ) 
		{
			case SDL_JOYHATMOTION:
				...
				/* Wiimote 2 Classic Controller 2 Pads */
				...
				/* Gamecube 1 Pads 2 Pads */
				if (event.jhat.which == 5)
				{
						if ( event.jhat.value == SDL_HAT_UP )
							_Inp.keyAltUp = BNX_TRUE;
						else if ( event.jhat.value == SDL_HAT_DOWN )
			...
			case SDL_JOYBUTTONDOWN:
					if ( event.jbutton.button==0 || event.jbutton.button==9 )
						_Inp.keyA = BNX_TRUE;
					else if ( event.jbutton.button==2 || event.jbutton.button==11 )
						_Inp.keyC = BNX_TRUE;
					else if ( event.jbutton.button==3 || event.jbutton.button==12 )
						_Inp.keyDel = BNX_TRUE;
					else if ( event.jbutton.button==4 || event.jbutton.button==17 )
						_Inp.keyPageUp	= BNX_TRUE;
					else if ( event.jbutton.button==5 || event.jbutton.button==18 )
						_Inp.keyPageDown = BNX_TRUE;
					else if ( event.jbutton.button==6 || event.jbutton.button==19 )
						_Inp.keyB = BNX_TRUE;
			break;
